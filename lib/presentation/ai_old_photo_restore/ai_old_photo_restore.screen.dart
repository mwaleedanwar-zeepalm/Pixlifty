...
import 'package:pixlify/presentation/ai_old_photo_restore/old_photo_restore_result.dart';
import 'package:pixlify/theme.dart';

class AiOldPhotoRestoreScreen extends StatelessWidget {
  const AiOldPhotoRestoreScreen({Key? key}) : super(key: key);
  ThemeService get theme => Get.find<ThemeService>();
  @override
  Widget build(BuildContext context) {
    return GetX<AiOldPhotoRestoreController>(
      init: AiOldPhotoRestoreController(),
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Upload an old photo, and we’ll enhance it.',
              ...
              if (controller.image == null)
                InkWell(
                  onTap: () {
                    Get.dialog<Widget>(
                      const ImagePickerDialogOldPhotoRestore(),
                    );
                  },
                  child: Container(
                    width: Get.width,
...
class ImagePickerDialogOldPhotoRestore extends StatelessWidget {
  const ImagePickerDialogOldPhotoRestore({super.key});
  AiOldPhotoRestoreController get controller =>
      Get.find<AiOldPhotoRestoreController>();
  ThemeService get theme => Get.find<ThemeService>();
  @override
  Widget build(BuildContext context) {
    return AlertDialog(
