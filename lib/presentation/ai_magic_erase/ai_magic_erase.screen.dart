...
import 'package:pixlify/presentation/ai_magic_erase/select_erase_area.dart';
import 'package:pixlify/theme.dart';

class AiMagicEraseScreen extends StatelessWidget {
  const AiMagicEraseScreen({Key? key}) : super(key: key);
  ThemeService get theme => Get.find<ThemeService>();
  @override
  Widget build(BuildContext context) {
    return GetX<AiMagicEraseController>(
      init: AiMagicEraseController(),
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Upload a photo or image, and click continue.',
              ...
              if (controller.image == null)
                InkWell(
                  onTap: () {
                    Get.dialog<Widget>(const ImagePickerDialogMagicErase());
                  },
                  child: Container(
                    width: Get.width,
                    height: 382.h,
...
class ImagePickerDialogMagicErase extends StatelessWidget {
  const ImagePickerDialogMagicErase({super.key});
