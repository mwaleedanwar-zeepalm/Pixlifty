...
import 'package:pixlify/presentation/ai_old_photo_recolor/old_photo_recolor_result.dart';
import 'package:pixlify/theme.dart';

class AiOldPhotoRecolorScreen extends StatelessWidget {
  const AiOldPhotoRecolorScreen({Key? key}) : super(key: key);
  ThemeService get theme => Get.find<ThemeService>();
  @override
  Widget build(BuildContext context) {
    return GetX<AiOldPhotoRecolorController>(
      init: AiOldPhotoRecolorController(),
            ...
            children: [
              ...
              if (controller.image == null)
                InkWell(
                  onTap: () {
                    Get.dialog<Widget>(
                      const ImagePickerDialogOldPhotoRecolor(),
                    );
                  },
                  child: Container(
                    width: Get.width,
...
class ImagePickerDialogOldPhotoRecolor extends StatelessWidget {
  const ImagePickerDialogOldPhotoRecolor({super.key});
